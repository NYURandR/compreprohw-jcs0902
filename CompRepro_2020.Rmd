...
Wilson et. al suggests that code should be contain comments that help direct users towards its purpose and ensure they can understand how the code should work. Tools like R can make scripting and commenting scripts easier through different routes, either by regularly commenting while scripting, or creating an RMD file that allows you to mix text and code in a straight forward manner as is done in the current document.
